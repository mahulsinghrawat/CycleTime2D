...
ipcMain.handle("save-excel-file", async (event, { defaultName, data }) => {
...
function createWindow() {
    ...
    const emitCanvasCommand = (command) => {
        win.webContents.send(command);
        void win.webContents
            .executeJavaScript(`window.dispatchEvent(new CustomEvent(${JSON.stringify(command)}));`, true)
            .catch((error) => {
